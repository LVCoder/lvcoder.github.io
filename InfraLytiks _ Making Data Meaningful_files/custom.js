...
jQuery(document).ready(function($){
	jQuery('.stores br').remove();
	jQuery('.btn br').remove();
	jQuery('.home-app__block br').remove();
	jQuery('.infradroneApp-info br').remove();
	jQuery('.home-drones__block p br').remove();
	jQuery('.hero__descr p br').remove();
	jQuery('.home-analys__block p br').remove();
	jQuery('.home-app__block p br').remove();
	
	
	if (window.location.href.indexOf("drones") > -1 || window.location.href.indexOf("application") > -1){ 
		jQuery('p br').remove();
		var bool = false;
	...
	if(jQuery('.drones-box h2 br').length!=0)
		jQuery('.drones-box h2 br')[0].remove();
	if(jQuery('.home-analys__block h2 br').length!=0)
		jQuery('.home-analys__block h2 br')[0].remove();
	if(jQuery('.hero__descr span br').length!=0)
		jQuery('.hero__descr span br')[0].remove();
	
	var arr_id = ['#first', '#second', '#third', '#fourth', '#fifth', '#sixth', '#seventh'];

    var thirdCounter = 0;
    var thirdInterv = setInterval(function(){
        jQuery('.thirdsectionMain .navig .green').removeClass('green');

        jQuery('.thirdsectionMain #first').hide();
        jQuery('.thirdsectionMain #second').hide();
        jQuery('.thirdsectionMain #third').hide();
        jQuery('.thirdsectionMain #fourth').hide();

        jQuery('.thirdsectionMain ' + arr_id[thirdCounter]).show();
        jQuery(jQuery('.thirdsectionMain .navig div')[thirdCounter]).addClass('green');
	...
	jQuery('.thirdsectionMain .grey').click(function(e){
        clearInterval(thirdInterv);

        jQuery('.thirdsectionMain .navig .green').removeClass('green')
        jQuery(e.target).addClass('green');
        ...
        jQuery('.thirdsectionMain #' + e.target.attributes[0].value).show();
    });
	
	var fifthCounter = 0;
    var fifthInterv = setInterval(function(){
        jQuery('.fifthsectionMain .navig .green').removeClass('green')

        jQuery('.fifthsectionMain #first').hide();
        jQuery('.fifthsectionMain #second').hide();
        jQuery('.fifthsectionMain #third').hide();


        jQuery('.fifthsectionMain ' + arr_id[fifthCounter]).show();
        jQuery(jQuery('.fifthsectionMain .navig div')[fifthCounter]).addClass('green');
    ...
    jQuery('.fifthsectionMain .grey').click(function(e){
        clearInterval(fifthInterv);
        ...
        jQuery('.fifthsectionMain #second').hide();
        jQuery('.fifthsectionMain #third').hide();
        jQuery('.fifthsectionMain #fourth').hide();

        jQuery('.fifthsectionMain #' + e.target.attributes[0].value).show();
    });


    jQuery('.optionsMain .grey').click(function(e){
        console.log(e);

        jQuery('.optionsMain .navig .green').removeClass('green')
        jQuery(e.target).addClass('green');

        jQuery('.optionsMain #first').hide();
        jQuery('.optionsMain #second').hide();
        jQuery('.optionsMain #third').hide();
        jQuery('.optionsMain #fourth').hide();
        jQuery('.optionsMain #fifth').hide();
        jQuery('.optionsMain #sixth').hide();
        jQuery('.optionsMain #seventh').hide();

        jQuery('.optionsMain #' + e.target.attributes[0].value).show();
    });
	
	 jQuery('.sliderOp').click(function(e){
        //window.Slider.slideNext();


		 jQuery('html, body').animate({
           'scrollTop':   jQuery('#slider-main').offset().top
         }, 1000);
		...
		console.log(e);
        jQuery('.optionsMain #' + e.currentTarget.attributes[1].value).show();

        for(var i = 0; i < jQuery('.navig div').length; i++ ){
            if(e.currentTarget.attributes[1].value == jQuery('.navig div')[i].attributes[0].value){
                jQuery(jQuery('.navig div')[i]).addClass('green');
            }
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_scrollreveal__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_component_swiper_min_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_component_swiper_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_component_swiper_min_js__);
...
//     window.Slider = new __WEBPACK_IMPORTED_MODULE_1_component_swiper_min_js___default.a(".slider", {
...
//     //calculate when to change options for slider
//     const scroll_handler = () => {
//       window.requestAnimationFrame(() => {
//         let top = window.scrollY || window.pageYOffset || document.documentElement.scrollTop;
...
//     }
    ...
    //drones page and applications
    if (doc.querySelector(".drones, .insurance")) {
      sr.reveal(".drones__img", { distance: "-150px", duration: 1000, scale: 1, origin: "left" }, 250);
      //sr.reveal(".applications-list__item", { duration: 500 }, 150);
      sr.reveal(".insurance-grid__item-text", { duration: 500 });
      sr.reveal(".drones-box", {
        distance: "-150px",
        duration: 1000,
        scale: 1,
        origin: "right"
    ...
    if (doc.querySelector(".hero")) {
      sr.reveal(".home-app__img", { distance: "-150px", duration: 1000, scale: 1, origin: "right" }, 250);
      sr.reveal(".home-drones__img", { distance: "-150px", duration: 1000, scale: 1, origin: "left" }, 250);
      sr.reveal(".hero__bg", { distance: "-150px", duration: 1000, scale: 1, origin: "left" }, 250);

      //sr.reveal(".applications-list__item", { duration: 500 }, 150);
    }

    //ANIMATIONS BLOCK ENDS
//   });
// } else {
//   alert("Please, renew your web browser for better performance.");
// }
...
(function() {
	...
	function logisticstoggleOverlay() {
	...
	if(jQuery('div.overlay.overlay-hugeinc').length) {
		...
		triggerBttn.addEventListener( 'click', logisticstoggleOverlay );
		closeBttn.addEventListener( 'click', logisticstoggleOverlay );
	}
